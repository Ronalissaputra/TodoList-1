    document.addEventListener('DOMContentLoaded', function () {
        ...
        function addTodo() {
            ...
            const todoObject = generateTodoObject(generatedID, judul, penulis, tahun, isCompleted);
          ...
          function makeTodo(todoObject) {
            ...
            judul.innerText = todoObject.judul;

            const penulis = document.createElement('p');
            penulis.innerText = todoObject.penulis;
           
            const tahun = document.createElement('p');
            tahun.innerText = todoObject.tahun;
